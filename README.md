...
## How to execute
### Basic installation
*Create a virtual environment with virtualenv in the root folder
*source .env/bin/activate
*pip install -r requirements.txt
*start both servers in api_service and stock_service with: python manage.py runserver. Make sure they run in 8000 for api_service and 8001 for stock_service
*Start a RabbitMQ server with: docker run -it -p 5672:5672 -p 15672:15672 rabbitmq:3-management  

### Token creation
*Create a superuser with: python manage.py createsuperuser
*Create other users in the Django admin panel
*Generate a token for admin or users with: python manage.py drf_create_token admin
* A username and a password can be associated to the token.
![This is an image](Instructions2.png)

### Postman
*In postman, do a post request to http://127.0.0.1:8000/stock/<str> . Then, click on authorization and introduce de API key as shown. Make sure to use the admin/user token.
![This is an image](Instruction.png)

### Check assigments
*For checking history, get request to: http://127.0.0.1:8000/history . Make sure to use the admin/user token.
*Stat checking: http://127.0.0.1:8000/stats
*Tests are on api_service/api. Run: python manage.py test

![This is an image](Instructions3.png)
